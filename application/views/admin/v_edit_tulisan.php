        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="<?php echo base_url() . 'admin/galeri' ?>">
              <i class="fa fa-picture-o"></i> <span>Image Bannerr</span>
              <span class="pull-right-container">
                <small class="label pull-right"></small>
              </span>
            </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Update Konten</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Update Konten</h3>
          </div>
          <?php
          $b = $data->row_array();
          ?>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <input type="text" name="xjudul" class="form-control" value="<?php echo $b['tulisan_judul']; ?>" placeholder="Judul konten atau artikel" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
