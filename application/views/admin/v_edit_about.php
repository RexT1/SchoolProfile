...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="box box-danger">
                    ...
                    <form action="<?php echo base_url() . 'admin/about/update_about' ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="hidden" name="kode" value="<?php echo $b['about_id']; ?>">
                                    <!-- <input type="text" name="xvisi" class="form-control" value="<?php echo $b['about_visi']; ?>" placeholder="Visi" required /> -->
                                    <textarea class="form-control" name="xvisi" required><?php echo $b['about_visi']; ?></textarea>
                                </div>
                                <!-- /.col -->
                                <div class="col-md-2">
    ...
    <script>
        $(function() {
            ...
            CKEDITOR.replace('ckeditor_misi');
            CKEDITOR.replace('ckeditor_sambutan');
