...
<header class="main-header">
  ...
  <a href="<?php echo base_url() . 'admin/dashboard' ?>" class="logo">
    ...
    <span class="logo-mini"><img class="logo-lg" width="50px;" src="<?php echo base_url() . 'theme/images/icon.png' ?>"></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img class="logo-lg" width="150px;" src="<?php echo base_url() . 'theme/images/logo-white.png' ?>"></span>
  </a>
