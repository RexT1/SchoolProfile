...
class M_pengguna extends CI_Model
{
	...
	{
		$hsl = $this->db->query("UPDATE tbl_pengguna set pengguna_password=md5('$password') where pengguna_id='$kode'");
		return $hsl;
	}
	...
	{
		$hsl = $this->db->query("SELECT * FROM tbl_pengguna where pengguna_id='1'");
		return $hsl;
	}

	function get_pengguna_author()
	{
		$hsl = $this->db->query("SELECT * FROM tbl_pengguna where pengguna_id='2'");
		return $hsl;
	}
}
